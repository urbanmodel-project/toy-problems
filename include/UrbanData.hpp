...
struct CanyonGeometryData {
  Array1DR8 canyon_hwr; // ratio of building height to street width
                        // (lun_pp%canyon_hwr) [cite: 1478]
  Array1DR8 vf_sr;      // view factor of sky for road (urbanparams_vars%vf_sr)
                        // [cite: 1136, 1340]
  Array1DR8 vf_sw; // view factor of sky for one wall (urbanparams_vars%vf_sw)
                   // [cite: 1136]
  Array1DR8 vf_rw; // view factor from road to wall (urbanparams_vars%vf_rw)
                   // [cite: 1340]
  Array1DR8 vf_ww; // view factor from wall to opposing wall
                   // (urbanparams_vars%vf_ww) [cite: 1340]
};
...
struct AlbedoFluxes {
  ...
  Array2DR8
      sabs_improad_dir; // direct solar absorbed by impervious road
                        // (solarabs_vars%sabs_improad_dir_lun) [cite: 1496]
  Array2DR8
      sabs_sunwall_dir; // direct solar absorbed by sunwall
                        // (solarabs_vars%sabs_sunwall_dir_lun) [cite: 1492]
