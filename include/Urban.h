...
// I/O
URBAN_EXTERN UrbanErrorCode UrbanSetInputs(UrbanType handle,
                                           const UrbanInputs *in);
URBAN_EXTERN UrbanErrorCode UrbanGetOutputs(UrbanType handle,
                                            UrbanOutputs *out);
...
URBAN_EXTERN UrbanErrorCode UrbanCopyOutputs(UrbanType handle, double *net_sw,
